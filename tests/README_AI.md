<!-- Generated by codeindex at 2026-02-10T18:25:07+08:00 -->
...
- **test_init_wizard_bdd.py** - BDD tests for Interactive Setup Wizard (Epic 15 Story 15.1). Tests wizard_context fixture, language auto-detection (Python, PHP, Java/Spring), smart pattern inference (include/exclude), configuration generation (.codeindex.yaml), CODEINDEX.md creation, Git Hooks installation, AI CLI setup, performance optimization, and zero-input setup flow.
...
**New File**: `test_init_wizard_bdd.py` added with comprehensive BDD tests for Interactive Setup Wizard (Epic 15 Story 15.1).

Changed files:
- `test_init_wizard_bdd.py` (added BDD tests covering wizard context, language detection, pattern inference, configuration generation, CODEINDEX.md creation, Git Hooks, AI CLI setup, and zero-input workflow)
