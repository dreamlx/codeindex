<!-- Generated by codeindex at 2026-02-05T17:25:29+08:00 -->
...
_Tests for Java annotation extraction (Story 7.1.2.1). Covers class, method, and field annotations with various argument patterns._
...
**Commit `2db9fb3`**: feat(parser): add Java annotation extraction (Story 7.1.2.1)
