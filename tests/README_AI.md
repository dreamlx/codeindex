<!-- Generated by codeindex at 2026-02-07T10:17:58+08:00 -->
...
- **test_java_calls.py** - TestBasicMethodCalls, TestConstructorCalls, TestStaticImportResolution, TestFullQualifiedNameCalls, TestMethodReferences, TestProjectInternalFiltering, TestEdgeCases, TestAnnotationBasedCalls. Epic 11 Story 11.2 comprehensive Java call extraction test suite with 30+ tests covering method calls, constructors, static imports, FQN resolution, method references, project filtering, edge cases, and annotation-based calls. Follows TDD approach targeting 90%+ passing rate.
