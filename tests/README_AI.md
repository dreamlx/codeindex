<!-- Generated by codeindex at 2026-01-26T15:09:41+08:00 -->

# README_AI.md - tests

## Purpose
Test suite for the codeindex package, providing comprehensive unit tests for core components including directory tree building, code parsing, smart writing functionality, symbol importance scoring with visibility-based, semantic importance, documentation quality, complexity-based, and naming pattern (noise detection) ranking, adaptive symbols configuration, adaptive symbol selector with size-based limits, and configuration loading with adaptive symbols support.

## Architecture
The test suite is organized into seven main test modules that mirror the core components of the codeindex package:
...
- `TestRealWorldScenarios`: Validates selector behavior with real PHP project file sizes (8891, 7924, 3521, 500 lines)
