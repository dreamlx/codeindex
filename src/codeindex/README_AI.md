<!-- Generated by codeindex at 2026-01-23T11:52:29+08:00 -->
...
- `def process_normal(path: Path, config: Config, use_fallback: bool, quiet: bool, timeout: int) -> bool`
  Process a single directory normally....
...
- .parser: ParseResult, parse_directory, parse_file
- .scanner: find_all_directories, scan_directory
