<!-- Generated by codeindex at 2026-01-23T15:11:25+08:00 -->
...
**Key Features:**
- `scan_all` supports AI enhancement for overview-level directories (default enabled)
- `--no-ai` flag disables AI enhancement, uses SmartWriter only
- `--fallback` is deprecated alias for `--no-ai`
- Hierarchical processing with bottom-up directory traversal
