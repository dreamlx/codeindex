<!-- Generated by codeindex at 2026-02-12T15:10:48+08:00 -->
...
**Purpose**: `scan` and `scan_all` commands for README_AI.md generation
...
### Scanner - Unified Language Extension Handling
...
### Tech Debt CLI - Java-Aware Hints

**File**: `cli_tech_debt.py`

**Java-Specific UX**:
- When analyzing an empty directory without `--recursive` flag, checks if Java is a configured language
- If Java is configured, displays a hint suggesting `--recursive (-r)` flag
