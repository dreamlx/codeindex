<!-- Generated by codeindex at 2026-01-26T11:13:59+08:00 -->
...
| `SymbolImportanceScorer` | Scores symbols by importance (0-100) for prioritized documentation |
...
| Symbol Importance Scoring | Multi-dimensional scoring (documentation quality 0-15pts, complexity 5-20pts, visibility, semantics, naming patterns -20 to 0pts) with language-specific visibility rules, semantic keyword matching (critical: create/update/delete/pay; secondary: find/search/query), and noise detection penalizing magic methods (__*: -20pts), private methods (_*: -15pts), and getter/setter/checker patterns (get*/set*/is*/has*: -10pts) |
...
| Symbol Scoring | Importance-based symbol prioritization with documentation quality scoring (comprehensive >200 chars: 15pts; medium >50 chars: 10pts; brief: 5pts; none: 0pts), complexity scoring (very large >100 lines: 20pts; large 50-100 lines: 15pts; medium 20-50 lines: 10pts; small <20 lines: 5pts), visibility scoring (PHP public/protected/private, Python naming conventions), semantic analysis (25pts: critical operations like pay/create/update; 15pts: query operations like find/search; 5pts: generic methods), and naming pattern penalties for noise reduction (magic methods __*: -20pts, private methods _*: -15pts, getter/setter/checker patterns get*/set*/is*/has*: -10pts) |
