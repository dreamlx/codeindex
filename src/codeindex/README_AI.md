<!-- Generated by codeindex at 2026-02-08T11:02:29+08:00 -->
...
Changed files:
- `cli_symbols.py` - Added UTF-8 encoding to file write operations
- `config.py` - Added UTF-8 encoding to file write operations
- `writer.py` - Added UTF-8 encoding to file write operations
