<!-- Generated by codeindex at 2026-01-27T19:45:08+08:00 -->
...
| Module | Role |
|--------|------|
| `cli.py` | Main CLI entry point with Click command definitions; imports shared resources from `cli_common` |
...
| Modular CLI Architecture | CLI split into `cli.py` (commands) and `cli_common.py` (shared utilities) for better maintainability and future command module expansion (Epic 4) |
