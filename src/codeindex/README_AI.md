<!-- Generated by codeindex at 2026-01-26T09:24:21+08:00 -->
...
| Symbol Importance Scoring | Multi-dimensional scoring (documentation quality, complexity, visibility, semantics, naming patterns) with language-specific visibility rules and semantic keyword matching (critical: create/update/delete/pay; secondary: find/search/query) |
...
| Symbol Scoring | Importance-based symbol prioritization with visibility scoring (PHP public/protected/private, Python naming conventions) and semantic analysis (25pts: critical operations like pay/create/update; 15pts: query operations like find/search; 5pts: generic methods) |
