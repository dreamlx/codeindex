<!-- Generated by codeindex at 2026-01-26T11:10:20+08:00 -->
...
| Symbol Importance Scoring | Multi-dimensional scoring (documentation quality 0-15pts, complexity 5-20pts, visibility, semantics, naming patterns) with language-specific visibility rules and semantic keyword matching (critical: create/update/delete/pay; secondary: find/search/query) |
...
| Symbol Scoring | Importance-based symbol prioritization with documentation quality scoring (comprehensive >200 chars: 15pts; medium >50 chars: 10pts; brief: 5pts; none: 0pts), complexity scoring (very large >100 lines: 20pts; large 50-100 lines: 15pts; medium 20-50 lines: 10pts; small <20 lines: 5pts), visibility scoring (PHP public/protected/private, Python naming conventions), and semantic analysis (25pts: critical operations like pay/create/update; 15pts: query operations like find/search; 5pts: generic methods) |
