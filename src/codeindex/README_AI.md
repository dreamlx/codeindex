<!-- Generated by codeindex at 2026-01-19T10:03:56+08:00 -->
...
- **`incremental.py`** - Git-based change analysis for incremental updates. Provides `analyze_changes()`, `get_dirs_to_update()`, and `should_update_project_index()`.
...
| `analyze_changes()`, `get_dirs_to_update()`, `UpdateLevel` | Incremental update analysis |
